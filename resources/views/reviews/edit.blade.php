        ...
        <form
            ...
            <div class="mb-6">
                ...
                <textarea
                    name="review"
                    rows="5"
                    class="w-full mt-2 bg-slate-800 border border-slate-700 rounded-xl p-3 text-white">{{ $review->review }}</textarea>
            ...
            <div class="flex gap-3">
                ...
                <button
                    type="submit"
                    class="bg-blue-600 hover:bg-blue-700 px-6 py-3 rounded-xl text-white font-semibold">
